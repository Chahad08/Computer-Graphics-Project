...
int main(int argc, char** argv)
{
  ...
  cout << "          COMPUTER GRAPHICS [E]           " << endl ;
    ...
    cout << "Submitted To : Dr. Md. ABDULLAH-AL-JUBAIR" << endl << endl;
    cout << "Submitted By : Nura Solahin Esha" << endl ;
    cout << "ID           : 19-39767-1" << endl << endl<< endl;
    cout << "Submitted By : Mahmud, Nafi" << endl ;
    cout << "ID           : 17-33793-1" << endl << endl<< endl;

    cout << "Submitted By : Md Sajedul Alam" << endl ;
    cout << "ID           : 18-36140-1" << endl << endl<< endl;
    cout << "Submitted By : Abu Hasnat Jelani Chahad" << endl ;
    cout << "ID           : 19-39734-1" << endl << endl<< endl;
